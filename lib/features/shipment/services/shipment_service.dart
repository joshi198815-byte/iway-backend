...
class ShipmentService {
  ...
  Future<ShipmentModel> createShipment(ShipmentModel shipment) async {
    final data = await _apiClient.post('/shipments', {
      ...
      'senderName': shipment.remitenteNombre,
      'senderPhone': shipment.remitenteTelefono,
      'senderAddress': shipment.remitenteDireccion,
      'senderStateRegion': shipment.remitenteRegion,
